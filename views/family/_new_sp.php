...
<!-- Accordion Item -->
<div id="<?="sp-".$increment?>">
    <p class="delete_item" onclick='deleteItem(<?=$increment?>,"sp",<?=isset($brak->id) ? $brak->id : null?>,<?=isset($razvod->id) ? $razvod->id : null?>);'><span class="icon-feather-trash-2" ></span> Удалить данные</p>
                                                    ...
                                                    <ul style="list-style: none;">
                                                        ...
                                                        <?foreach ($files as $file):?>
                                                            <li id="<?=$file->id?>">
                                                                ...
                                                                <a href='#' onclick="deleteImg(<?=$file->id?>,'<?='sp'?>',<?=$razvod->ticket_id?>);" ><span class="icon-feather-trash-2"></span></a>
                                                            </li>
                                                        <?endforeach;?>
                                                    </ul>
                                                <? endif; ?>
