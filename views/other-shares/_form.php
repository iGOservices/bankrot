...
<div class="other-shares-form">
    ...
    <?= $form->field($model, 'type')->dropDownList(OtherShares::$type) ?>
    ...
    <?= $form->field($uploadForm, "other_shares[]")->fileInput(['multiple' => true])->label('Скан свидетельства о рождении') ?>

    <?
    $str = "";
    if($files = $model->getOtherSharesFiles()->all()){
        $str .= "<span>Скан файл документа подтверждающего обязательство:</span><ul>";
