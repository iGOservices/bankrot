									...
									<div class="row">
										...
										<div class="col-xl-6">
											<div class="submit-field">
                                                <?= $form->field($model, 'username')->textInput(['maxlength' => true, 'class' => 'with-border']) ?>
											</div>
										</div>

										<div class="col-xl-6">
											<div class="submit-field">
                                                <?= $form->field($model, 'phone')->textInput(['class' => 'with-border']) ?>
											</div>
										</div>

                                        <div class="col-xl-6">
											<div class="submit-field">
												<?= $form->field($model, 'email')->textInput(['maxlength' => true, 'class' => 'with-border']) ?>
											</div>
										</div>
										...
										<div class="col-xl-6">
											<!-- Account Type -->
											<div class="submit-field">
                                                    <?= Html::submitButton('Сохранить', ['class' => 'button ripple-effect']) ?>
											</div>
										</div>
