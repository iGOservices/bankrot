    ...
    <div id="header">
        <div class="container">
            ...
            <div class="left-side">
                ...
                <!-- Logo -->
                <div id="logo">
                    <a href="index.html"><img src="/images/logo_bankrot.jpeg" alt=""></a>
                </div>
                    ...
                    <div class="header-notifications user-menu">
                        ...
                        <div class="header-notifications-dropdown">
                            ...
                            <ul class="user-menu-small-nav">
                                <li><a href="dashboard.html"><i class="icon-material-outline-dashboard"></i> Регистрация</a></li>
                                <li><a href="dashboard-settings.html"><i class="icon-material-outline-settings"></i> Авторизация</a></li>
...
<div class="intro-banner" data-background-image="images/back_img.jpg">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="banner-headline">
                    <h3>
                        <strong>НЕТ ВОЗМОЖНОСТИВЫПЛАЧИВАТЬ КРЕДИТЫ?</strong>
                        <br>
                        <span>Если не спишем - верну  <strong class="color">100%</strong> оплаты по письменной гарантии!</span>
                    </h3>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="intro-banner-search-form margin-top-95">
                    ...
                    <div class="intro-search-field with-autocomplete">
                        <label for="autocomplete-input" class="field-title ripple-effect">Как вас зовут?</label>
                        <div class="input-with-icon">
                            <input id="autocomplete-input" type="text" placeholder="Имя">
                    ...
                    <div class="intro-search-field">
                        <label for ="intro-keywords" class="field-title ripple-effect">Как с вами связаться?</label>
                        <input id="intro-keywords" type="text" placeholder="Телефон">
                    </div>

                    <!-- Button -->
                    <div class="intro-search-button">
                        <button class="button ripple-effect" onclick="window.location.href='jobs-list-layout-full-page-map.html'">Оставить заявку</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="section-headline centered margin-bottom-15">
                    <h3>8 простых шагов к жизни без долгов</h3>
                </div>
                ...
                <div class="categories-container">
                    ...
                    <a href="jobs-list-layout-full-page-map.html" class="category-box">
                        ...
                        <div class="category-box-content">
                            ...
                            <div class="category-box-counter">Шаг 1</div>
                            <p>Cпециалисты ответят на все Ваши вопросы, с Вашего разрешения зададут уточняющие вопросы по делу и подробно проконсультируют по особенностям процедуры.</p>
                    ...
                    <a href="jobs-list-layout-full-page-map.html" class="category-box">
                        ...
                        <div class="category-box-content">
                            <h3>Позвоните по телефону</h3>
                            <div class="category-box-counter">Шаг 2</div>
                            <p>Cпециалисты ответят на все Ваши вопросы, с Вашего разрешения зададут уточняющие вопросы по делу и подробно проконсультируют по особенностям процедуры.</p>
                    ...
                    <a href="jobs-list-layout-full-page-map.html" class="category-box">
                        ...
                        <div class="category-box-content">
                            <h3>Позвоните по телефону</h3>
                            <div class="category-box-counter">Шаг 3</div>
                            <p>Cпециалисты ответят на все Ваши вопросы, с Вашего разрешения зададут уточняющие вопросы по делу и подробно проконсультируют по особенностям процедуры.</p>
                    ...
                    <a href="jobs-list-layout-full-page-map.html" class="category-box">
                        ...
                        <div class="category-box-content">
                            <h3>Позвоните по телефону</h3>
                            <div class="category-box-counter">Шаг 4</div>
                            <p>Cпециалисты ответят на все Ваши вопросы, с Вашего разрешения зададут уточняющие вопросы по делу и подробно проконсультируют по особенностям процедуры.</p>
                    ...
                    <a href="jobs-list-layout-full-page-map.html" class="category-box">
                        ...
                        <div class="category-box-content">
                            <h3>Позвоните по телефону</h3>
                            <div class="category-box-counter">Шаг 5</div>
                            <p>Cпециалисты ответят на все Ваши вопросы, с Вашего разрешения зададут уточняющие вопросы по делу и подробно проконсультируют по особенностям процедуры.</p>
                    ...
                    <a href="jobs-list-layout-full-page-map.html" class="category-box">
                        ...
                        <div class="category-box-content">
                            <h3>Позвоните по телефону</h3>
                            <div class="category-box-counter">Шаг 6</div>
                            <p>Cпециалисты ответят на все Ваши вопросы, с Вашего разрешения зададут уточняющие вопросы по делу и подробно проконсультируют по особенностям процедуры.</p>
                    ...
                    <a href="jobs-list-layout-full-page-map.html" class="category-box">
                        ...
                        <div class="category-box-content">
                            <h3>Позвоните по телефону</h3>
                            <div class="category-box-counter">Шаг 7</div>
                            <p>Cпециалисты ответят на все Ваши вопросы, с Вашего разрешения зададут уточняющие вопросы по делу и подробно проконсультируют по особенностям процедуры.</p>
                    ...
                    <a href="jobs-list-layout-full-page-map.html" class="category-box">
                        ...
                        <div class="category-box-content">
                            <h3>Позвоните по телефону</h3>
                            <div class="category-box-counter">Шаг 8</div>
                            <p>Cпециалисты ответят на все Ваши вопросы, с Вашего разрешения зададут уточняющие вопросы по делу и подробно проконсультируют по особенностям процедуры.</p>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-md-4">
                ...
                <div class="icon-box with-line">
                    ...
                    <h3>Позвоните по телефону или оставьте заявку через сайт</h3>
                    <p>Cпециалисты ответят на все Ваши вопросы, с Вашего разрешения зададут уточняющие вопросы по делу и подробно проконсультируют по особенностям процедуры.</p>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-md-4">
                ...
                <div class="icon-box with-line">
                    ...
                    <h3>Подача документов в суд</h3>
                    <p>Важный этап, после которого назначается дата судебного заседания. Необходимо учесть все тонкости Вашей ситуации, правильно подготовить документы и стратегию действий. </p>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-md-4">
                ...
                <div class="icon-box">
                    ...
                    <h3>Списание кредитов и долгов</h3>
                    <p>Самый продолжительный и не менее ответственный этап. Вам останется просто подождать до полного решения Вашей проблемы.</p>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="col-xl-12">
            <div class="section-headline border-top margin-top-55 padding-top-45 margin-bottom-25">
                <h4>Вы попали в сложную финансовую ситуацию и решить ее с кредитором не получается? Личное банкротство поможет Вам!</h4>
            </div>
            <p>В 2019 году в России гражданам в банкротстве уже списали более 314 миллиардов рублей задолженности. В первую очередь, найдите финансового управляющего – специалиста в сфере банкротства, который займется именно Вашей проблемой. Для этого и создан наш сайт: просто выберите специалиста, который гарантированно будет готов Вам помочь, и начните жизнь с чистого листа.</p>
            <p>Мы крупная компания и основной упор делаем на личных рекомендациях наших клиентов после успешного завершения дел и качественного обслуживания, а не на сиюминутной выгоде любыми способами.</p>
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                ...
                <div class="section-headline margin-top-0 margin-bottom-25">
                    <h3>КОМАНДА, КОТОРАЯ ВСЕГДА НА СВЯЗИ</h3>
                ...
                <div class="default-slick-carousel freelancers-container freelancers-grid-layout">
                    ...
                    <div class="freelancer">
                        ...
                        <div class="freelancer-overview">
                            <div class="freelancer-overview-inner">
                                ...
                                <div class="freelancer-avatar">
                                    ...
                                    <a href="single-freelancer-profile.html"><img src="images/admin_img.png" alt=""></a>
                                </div>

                                <!-- Name -->
                                <div class="freelancer-name">
                                    <h4><a href="single-freelancer-profile.html">Иван Иванов <img class="flag" src="images/flags/gb.svg" alt="" title="United Kingdom" data-tippy-placement="top"></a></h4>
                        ...
                        <div class="freelancer-details">
                            ...
                            <a href="single-freelancer-profile.html" class="button button-sliding-icon ripple-effect">Связаться<i class="icon-material-outline-arrow-right-alt"></i></a>
                        </div>
                    </div>
                    <div class="freelancer">
...
<div class="section padding-top-60 padding-bottom-75">
    ...
    <?else:?>
        ...
        <!-- Intro Banner
        ================================================== -->
        <div class="intro-banner dark-overlay" data-background-image="images/back_img.jpg">
